...
def cal_conversion_uplift(A_total, B_total, A_converted, B_converted):
    ...
    try:
        the_uplift = (
            cal_conversion_rate(B_total,B_converted) -  cal_conversion_rate(A_total,A_converted)
...
def cal_p_value(data, test=None):
    ...
    if test == 'binom':
        A_total, B_total, A_converted, B_converted = data.get('A_total'), data.get('B_total'), data.get('A_converted'), data.get('B_converted')
