...
class ABTestRatiosNaive():
    ...
    def pooled_probability(self):
        ...
        A_total, B_total, A_converted, B_converted = self.A_total, self.B_total, self.A_converted, self.B_converted
    ...
    def report(self, with_data = None, pipeline=None):
        ...
        all_pipes = [
            meth for meth in dir(self) if callable(
                getattr(self, meth)
...
if __name__ == "__main__":
    ...
    one_ab_test = {'A_converted': 43, 'A_total': 17207, 'B_converted': 68, 'B_total': 17198}

    print(
        cal_p_value(one_ab_test)
    )
